...
## observations from a population with mean and variance .
...
## cc for women with a standard deviation of 75 cc. Consider the sample mean of 
## 100 random adult women from this population. What is the 95th percentile of 
...
## mean of people per hour. You watch the bus stop for 3 hours. About what's the 
