...
## the new treatment. What does the 95% independent group confidence interval 
## with unequal variances suggest vis a vis this hypothesis? (Because there's 
## so many observations per group, just use the Z quantile instead of the T.)
