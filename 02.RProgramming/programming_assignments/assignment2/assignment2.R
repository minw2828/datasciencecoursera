...
##
## The following function, cachemean calculates the mean of the special "vector" 
...
## - Clone your forked GitHub repository to your computer so that you can edit the 
##   files locally on your own machine.
## - Edit the R file contained in the git repository and place your solution in that 
##   file (please do not rename the file).
## - Commit your completed R file into YOUR git repository and push your git branch
...
## the 40 character SHA-1 hash (as string of numbers from 0-9 and letters from a-f) that 
## identifies the repository commit that contains the version of the files you want to 
## submit. You can do this in GitHub by doing the following
