...
trend <- ddply(NEI, .(year), summarise, total_emission_year=sum(Emissions))

png("plot1.png")
plot(trend$year, trend$total_emission_year, type="l", main="Total PM2.5 emissions in 
     the United States (1999-2008)", xlab="year", ylab="Amount of PM2.5 emitted (tons)")
dev.off()
